      ...
      <div class="container">
         <div class="goods-forms text-center">
            <form name="MainForm" method="POST" action="controller">
               ...
               <button type="submit" class="btn btn-default btn-xs" name="write">Write to mr. A</button>
               <button type="submit" class="btn btn-default btn-xs" name="myOders">My oders</button>
               <button type="submit" class="btn btn-default btn-xs" name="myInfo">My info</button>
               <br />
            </form>
         </div>
